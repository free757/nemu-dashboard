...
1. CRITICAL: REFRIGERATOR & BOTTLE/BAG ACTION SEQUENCES (STRICT GROUND TRUTH MAPPING):
   - Segment 1 (Bottle pickup & hand pass):
   ...
   - Segment 2 (Bottle placement on counter):
     * Input: "place syrup bottle on counter..."
     * Ground Truth: "place bottle on counter with left hand"
   - Segment 3 (Red snack bag / sachet):
     * Input: "pick up red snack bag with right hand, place red snack bag on counter..."
     * Ground Truth: "pick up sachet with right hand, place sachet on counter with right hand"
   - Segment 4 (Orange snack bag / bag pass):
     * Input: "pick up orange snack bag with right hand, place orange snack bag..."
...
2. CRITICAL: SCREWDRIVER & ELECTRICAL PLUG ACTION SEQUENCES (STRICT GROUND TRUTH MAPPING):
   - Segment 1 (Pick up screws from tray): "hold screwdriver with left hand, pick up screws from tray with right hand"
   - Segment 2 (Holding screws): "hold screwdriver and electrical plug with left hand, hold screws with right hand"
   - Segment 3 (Placing screws on table): "hold screwdriver and electrical plug with left hand, place screws on table with right hand"
   - Segment 4 (Positioning screw on tip): "hold screwdriver and electrical plug with left hand, position screw on screwdriver tip with right hand"

3. CRITICAL: CLOTH SMOOTHENING & COLOR ADJECTIVE RULES:
...
5. CRITICAL: FARMING & GARDENING RULES (STRICT SEGMENT SCOPING):
...
6. CRITICAL: BOOK WIPING RULES (ALWAYS "hold book", NEVER "rotate", NEVER "page"):
...
7. CRITICAL: CONTAINER WIPING & ROTATION SEQUENCE (3D ROUND CONTAINERS ONLY):
...
8. CRITICAL: HOSE & WATERING CAN BOTH-HANDS ATTRIBUTION & SEQUENTIAL PICKUP:
...
9. CRITICAL: OBJECT NOUN SIMPLIFICATION & SPECIFIC ITEM NAMES:
...
10. CRITICAL: HAND-TO-HAND PASSES & SEQUENTIAL PLACING:
...
11. NO REDUNDANT "HOLD" PREPENDING TO ACTIVE MOTION VERBS:
...
12. CRITICAL: WIRE & CABLE STRIPPING / TWISTING / FOLDING:
...
13. CRITICAL: SEWING & STITCHING NEEDLE ACTIONS:
...
14. MANDATORY ATLAS RUBRIC BULLETS (OFFICIAL REQUIREMENTS):
...
15. OFF-HAND CLAUSE & HAND-TO-HAND PASSES (PDF PAGE 2):
...
16. ABSOLUTE BAN ON VAGUE WORDS & APPROVED ALTERNATIVES (PDF PAGE 3 & 4):
    - ❌ NEVER USE "inspect", "adjust", "reposition", "reach", "manipulate", "tool", "grab".

17. COMBining MULTIPLE OBJECTS HELD BY THE SAME HAND:
    - "hold screwdriver and electrical plug with left hand".

18. HOLDING & SMOOTHENING ACTIONS:
    - "hold cloth in left hand, smoothen cloth with right hand" (use "smoothen").

19. FLUID COMPOUND CLAUSE & SURFACE LOCATION:
