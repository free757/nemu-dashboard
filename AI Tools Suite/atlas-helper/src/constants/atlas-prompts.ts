...
3. CRITICAL: PAPER & SCISSORS EPISODE OVERRIDE (STRICT GROUND TRUTH MAPPING):
...
4. CRITICAL: MINIMAL-EDIT & VALIDITY PRINCIPLE (FOR GENERAL ASSESSMENT):
...
5. CRITICAL: WHEN TO MODIFY (ONLY FOR SPECIFIC RUBRIC VIOLATIONS):
...
6. KNOWN CLIP REFERENCE ANCHORS (FOR PRACTICE EXERCISES ONLY):
   - Sewing Cap:
