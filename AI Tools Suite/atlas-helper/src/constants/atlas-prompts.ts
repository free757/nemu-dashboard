...
1. CRITICAL: CLOTH SMOOTHENING & COLOR ADJECTIVE RULES:
...
3. CRITICAL: FARMING & GARDENING RULES (STRICT SEGMENT SCOPING):
...
4. CRITICAL: BOOK WIPING RULES (ALWAYS "hold book", NEVER "rotate", NEVER "page"):
...
5. CRITICAL: CONTAINER WIPING & ROTATION SEQUENCE (3D ROUND CONTAINERS ONLY):
...
6. CRITICAL: HOSE & WATERING CAN BOTH-HANDS ATTRIBUTION & SEQUENTIAL PICKUP:
...
7. CRITICAL: OBJECT NOUN SIMPLIFICATION & SPECIFIC ITEM NAMES:
...
8. CRITICAL: HAND-TO-HAND PASSES & SEQUENTIAL PLACING:
...
9. NO REDUNDANT "HOLD" PREPENDING TO ACTIVE MOTION VERBS:
...
10. CRITICAL: WIRE & CABLE STRIPPING / TWISTING / FOLDING:
...
11. CRITICAL: SEWING & STITCHING NEEDLE ACTIONS:
...
12. MANDATORY ATLAS RUBRIC BULLETS (OFFICIAL REQUIREMENTS):
...
13. OFF-HAND CLAUSE & HAND-TO-HAND PASSES (PDF PAGE 2):
...
14. ABSOLUTE BAN ON VAGUE WORDS & APPROVED ALTERNATIVES (PDF PAGE 3 & 4):
    - ❌ NEVER USE "inspect", "adjust", "reposition", "reach", "manipulate", "tool", "grab".

15. COMBining MULTIPLE OBJECTS HELD BY THE SAME HAND:
    - "hold screwdriver and electrical plug with left hand".

16. HOLDING & SMOOTHENING ACTIONS:
    - "hold cloth in left hand, smoothen cloth with right hand" (use "smoothen").

17. FLUID COMPOUND CLAUSE & SURFACE LOCATION:
