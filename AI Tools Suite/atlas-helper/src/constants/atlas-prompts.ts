...
1. CRITICAL: HOSE & WATERING CAN BOTH-HANDS ATTRIBUTION & SEQUENTIAL PICKUP:
   ...
   - ❌ NEVER use "place" when setting hose on ground if followed by picking up watering can (Atlas flags: expected "set", not "place").

2. CRITICAL: OBJECT NOUN SIMPLIFICATION & SPECIFIC ITEM NAMES:
...
3. CRITICAL: HAND-TO-HAND PASSES & SEQUENTIAL PLACING:
...
4. NO REDUNDANT "HOLD" PREPENDING TO ACTIVE MOTION VERBS:
...
6. CRITICAL: WIRE & CABLE STRIPPING / TWISTING / FOLDING:
...
7. CRITICAL: SEWING & STITCHING NEEDLE ACTIONS:
...
9. OFF-HAND CLAUSE & HAND-TO-HAND PASSES (PDF PAGE 2):
...
10. ABSOLUTE BAN ON VAGUE WORDS & APPROVED ALTERNATIVES (PDF PAGE 3 & 4):
    - ❌ NEVER USE "inspect", "adjust", "reposition", "reach", "manipulate", "tool", "grab".

11. CRITICAL: WIPING / CLEANING / ROTATING CONTAINERS:
